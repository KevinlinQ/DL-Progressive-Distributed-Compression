...
% semilogy(dim,mse_lower_bound,'o-','color',color1,'lineWidth',2,'markersize',8);
% hold on 
% semilogy(dim,mse_evd,'v-','color',color2,'lineWidth',2,'markersize',8);
% hold on
...
% % hold on
% semilogy(dim,DNN,'d-','color',color4,'lineWidth',2,'markersize',8);
% hold on
% % semilogy(dim,DNN_progressive,'s-','color',color5,'lineWidth',2,'markersize',8);
% hold on
% semilogy(dim,DNN_progressive_loss_sum,'s-','color',color5,'lineWidth',2,'markersize',8);
% hold on
